        ...
        {FEATURES.map((f, idx) => {
          ...
          return (
            motion.div 
              ...
              className={`grid grid-cols-1 lg:grid-cols-2 gap-16 items-center ${reverse ? 'lg:[&>div:first-child]:order-2' : ''}`}
            >
              <motion.div
            ...
            >
              ...
              ></motion.div>
                ...
                Link to=\"/demo\" className=\"mt-7 inline-flex items-center gap-1.5 text-sm font-medium text-slate-900 hover:text-indigo-600 transition-colors\">
             ...
             /motion.div>
              <motion.div 
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.6, delay: 0.2 }}
                className=\"relative rounded-2xl bg-white border border-slate-200 shadow-xl shadow-slate-900/5 overflow-hidden aspect-[4/3]\"
              >
